...
exports.AppError = exports.createErrorResponse = exports.ERROR_MESSAGES = exports.ERROR_CODES = void 0;
exports.ERROR_CODES = {
    // General Errors
 ...
 */
const createErrorResponse = (code, customMessage) => {
    const errorInfo = exports.ERROR_MESSAGES[code] || exports.ERROR_MESSAGES[exports.ERROR_CODES.INTERNAL_SERVER_ERROR];
    return {
        code,
