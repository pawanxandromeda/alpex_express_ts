...
-- CreateIndex
CREATE INDEX "MasterPassword_createdByEmployeeId_idx" ON "MasterPassword"("createdByEmployeeId");

-- CreateIndex
CREATE INDEX "MasterPassword_updatedByEmployeeId_idx" ON "MasterPassword"("updatedByEmployeeId");

-- CreateIndex
CREATE INDEX "MasterPassword_isActive_idx" ON "MasterPassword"("isActive");
...
-- AddForeignKey
ALTER TABLE "MasterPasswordUsageLog" ADD CONSTRAINT "MasterPasswordUsageLog_usedByEmployeeId_fkey" FOREIGN KEY ("usedByEmployeeId") REFERENCES "Employee"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
